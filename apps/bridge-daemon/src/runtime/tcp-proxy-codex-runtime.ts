...
import { JsonRpcTcpClient } from "./json-rpc-tcp-client";
import type {
...
export class TcpProxyCodexRuntime implements CodexRuntime {
  readonly backend = "tcp-proxy";
  private readonly client: JsonRpcTcpClient;

  constructor(
    private readonly config: BridgeConfig,
    logger: Logger,
  ) {
    this.client = new JsonRpcTcpClient(config, logger);
  }
